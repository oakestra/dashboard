...
export class NavbarComponent implements OnInit {
    ...
    private checkAndAddAddonMenus(): void {
        this.addonsApi.checkAvailability().subscribe((availability) => {
            const items: NbMenuItem[] = [];

            if (availability.addons || availability.marketplaceUi) {
                const children: NbMenuItem[] = [];

                if (availability.addons) {
                    children.push(
                        {
                            title: 'Marketplace',
                            icon: 'shopping-cart-outline',
                            link: '/control/addons/marketplace',
                        },
                        {
                            title: 'Installed',
                            icon: 'archive-outline',
                            link: '/control/addons/installed',
                        },
                    );
                }
            ...
            if (availability.customResources) {
                items.push({
