...
import * as addonsSelector from './selectors/addons.selector';
...
export { AddonsEffects } from './effects/addons.effects';

export { appReducer, serviceSelector, userSelector, applicationSelector, organizationSelector, settingsSelector, addonsSelector };
...
export * from './actions/addons.actions';
